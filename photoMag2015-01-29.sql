...
--
-- Värd: localhost
-- Tid vid skapande: 29 jan 2015 kl 11:00
...
(1, 'HIHIHHIHIHI', 'home', 'menu-main-menu', NULL, 0),
(12, 'Dennis bro', 'dennis-bro', 'menu-main-menu', 1, 0);
...
(1, 'Dennis is the shieat', 'Dennus the litle bou', NULL, 1, NULL, '2015-01-25 18:48:33'),
(12, 'Dennis lampardo', 'Dennis kommer och går över en bro som om allt vore i sin ordning.. Men en dag..', NULL, 1, NULL, '2015-01-26 11:54:57');
...
--
ALTER TABLE `menu_links`
MODIFY `mlid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
